...
export default function PostDetails(){
    ...
    return(
        <div  className="grid grid-col-1 lg:grid-cols-[70fr_30fr] lg:gap-4 mx-4 mb-10">
                {console.log(blog)}
                <div className="">
                    <img src={`http://localhost:3000/uploads/${blog.image.filename}`} alt={blog.image.filename} className='mx-auto my-5 w-full'/>
                    <div className="text-3xl my-5 text-center">{blog.title}</div>
            ...
            <div id='section2'  className="mt-10">
                <div id='author' className="my-5 pb-5 rounded-lg border-[2px] border-[rgb(236,240,243)]">
